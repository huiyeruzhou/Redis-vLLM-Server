...
我找到了一个非常好的仓库：[asprenger/ray_vllm_inference](https://github.com/asprenger/ray_vllm_inference)，我fork了一个版本以支持pydantic_v2和一些其他兼容性问题，并且对http客户端同样进行了调优。改进后的仓库位于：[huiyeruzhou/ray_vllm_inference](https://github.com/huiyeruzhou/ray_vllm_inference)，
...
![用例图](https://www.plantuml.com/plantuml/svg/ZPNFQzH05CVlyrUClTX0SvYNdiHAmTCU1As2Xzf3J5wxmsQJTZRn1o9K4Ldqq8gYWcL5yIQsUEfXGV-PPhVzBqmpaycFP1Dx6VhUzttUzytaiUkZq1PXDFJ8bR2FGwGEYiX3soSUReSq3AZWE_sGkboW4_B09-GgZO-_pyQdyvydPDTs1lOEqYKTMgBF24t-DdKaFfwS_NcxHUqHlUbnz4Fo_1AoWIuVtUAkw-5ZMs2EgYGqi19FWRT5yEIfv9rDf_6RRnUVlyRZJpci6Cr8Un56QPy4uvO52LA6xzcZmPrBNR6Yvs-ZGD_1Mf7EwBh2a7THF48XkRcpMYgpvmJ3tS17FrIQ-u4Oe52-MC6ZJB3k8gWLGSsUdg3HeSvscDGwLhwMRgkv5kgbsl1y-dusEQe-ievM7xcSeij2u1upr6sC8YzCdugr5q2j01ONyCOELdj1lSDgCcx-KSS7xoxsNn2vFTGqRyZldbvJRtf-SZhx_P9kfkCjU-YlMSOAr_ymO-k1h-yp4_Eg638naVIaJtKPTCVurw6q9dkQR4MUe4uhFS5aHPYsKEJfO8xa2iaLaYiaLyZ2nVnuDJzyJIekjNEz8acV-E2Zh7beXqv_3UXovfmgwqOd1reubkGa_WnI7xGyVvihdhbIq_yl3HRI8ATP1cd2NJSt-znrqTyowGRhL42NeiSw5K08AQvWaarx5s8WOr2CMMciLzAjoXWaG9RSZ5bzUlc-SklO2ZIfeAooo0Oir80YaPxaDBmgBpTi5a9PQ94UjCbqMo8tAXswU8Fb4Pf5UeOsaIKxjfDMoxP8lkRgHpx9d__z47-Pp8xsvzEnagsZxqP3xny0)
> 上图展示了客户端向Reward和Inference LLM分别发起了带有3个prompt和1个prompt的请求时的情形，可以看到中间件拆分任务，worker从任务队列中批量读取并按照request写回结果队列，中间件再从结果队列返回到客户端的过程
